<footer class="footer">
    <div class="div-46">
        <div>
            <div class="div-47">
                ...
                <div>
                    <div>
                        <svg
                            id="I1:2077;325:12998"
                            layer-name="Logo Instagram"
                            width="25"
                            height="24"
                            viewBox="0 0 25 24"
                            fill="none"
                ...
                <div>
                    <div>
                        <svg
                            id="I1:2077;325:13119"
                            layer-name="Logo YouTube"
                            width="25"
                            height="24"
                            viewBox="0 0 25 24"
                            fill="none"
                        ...
                        >
                            <g clip-path="url(#clip0_5_335)">
                                <path
                                    d="M20.595 3.184C16.991 2.938 8.96402 2.939 5.36502 3.184C1.46802 3.45 1.00902 5.804 0.980019 12C1.00902 18.185 1.46402 20.549 5.36502 20.816C8.96502 21.061 16.991 21.062 20.595 20.816C24.492 20.55 24.951 18.196 24.98 12C24.951 5.815 24.496 3.451 20.595 3.184ZM9.98002 16V8L17.98 11.993L9.98002 16Z"
                                    fill="#1E1E1E"
                                ></path>
                            </g>
                            <defs>
        ...
        <div class="div-48">
            <div class="div-49">
                <div class="div-50">Use cases</div>
                <div class="div-51">Mood Tracking</div>
                <div class="div-52">Anxiety & Stress Management</div>
                <div class="div-53">Therapy Sessions</div>
                <div class="div-54">Meditation & Mindfulness</div>
                <div class="div-55">Journaling & Reflection</div>
                <div class="div-56">Community Support</div>
            </div>
            <div class="div-57">
                <div class="div-58">Explore</div>
                <div class="div-59">Mental Health Insights</div>
                <div class="div-60">Self-Care Exercises</div>
                <div class="div-61">AI-Powered Recommendations</div>
                <div class="div-62">Personalized Therapy Plans</div>
                <div class="div-63">Emotional Well-being Resources</div>
                <div class="div-64">Wellness Challenges</div>
            </div>
            <div class="div-65">
                <div class="div-66">Resources</div>
                <div class="div-67">Blog</div>
                <div class="div-68">Best practices</div>
                <div class="div-69">Colors</div>
                <div class="div-70">Color wheel</div>
                <div class="div-71">Support</div>
                <div class="div-72">Developers</div>
            </div>
        </div>
    </div>
</footer>
